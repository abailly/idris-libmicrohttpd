...
{
  return MHD_start_daemon (flags, port, apc, apc_cls, dh, dh_cls, MHD_OPTION_CONNECTION_MEMORY_LIMIT, connection_memory_limit, MHD_OPTION_CONNECTION_LIMIT, connect_limit,
			   MHD_OPTION_CONNECTION_TIMEOUT, connect_timeout, MHD_OPTION_PER_IP_CONNECTION_LIMIT, ip_connection_limit, MHD_OPTION_THREAD_POOL_SIZE, thread_pool_size,
			   MHD_OPTION_THREAD_STACK_SIZE, thread_stack_size, MHD_OPTION_TCP_FASTOPEN_QUEUE_SIZE, fastopen_queue_size, MHD_OPTION_ARRAY, ops, MHD_OPTION_END);
}
...
char * make_string_2 (char * str) {return str;} 
